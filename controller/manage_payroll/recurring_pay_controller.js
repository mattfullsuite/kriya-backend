...
function GetRecurringPayItems(req, res) {
  ...
  const q =
    "SELECT `pay_items_id` AS 'Pay Item ID', `pay_item_name` as 'Name' FROM `pay_items` WHERE company_id = ? AND pay_item_type LIKE 'Fixed' AND pay_item_name != 'Basic Pay' AND pay_item_name != 'Team Lead Allowance'";
