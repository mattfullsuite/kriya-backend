...
function GetInferiorAndSuperior(req, res) {
    ...
    const q = "(SELECT a.emp_id, a.f_name, a.m_name, a.s_name, a.superior_id, b.emp_id, b.f_name AS s_f_name, b.m_name AS s_m_name, b.s_name  AS s_s_name, b.superior_id FROM emp AS a INNER JOIN emp AS b ON a.superior_id = b.emp_id ORDER BY a.f_name ASC) UNION (SELECT a.emp_id, a.f_name, a.m_name, a.s_name, a.superior_id, emp_id IS NULL AS s_emp_id, f_name IS NULL AS s_f_name, m_name IS NULL AS s_m_name, s_name IS NULL AS s_s_name, superior_id IS NULL AS s_superior_id FROM emp AS a WHERE a.superior_id IS NULL ORDER BY s_f_name ASC)"
