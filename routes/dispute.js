...
router.get("/d-getAllPayrollDispute", viewPayrollDisputes);
router.get("/d-getUserdispute", viewUserDisputes);
router.get("/d-getUserPayrollDispute", viewUserPayrollDisputes);
...
router.get(
  "/d-get-requester-disputes/:type/:requesterID",
  GetRequesterDisputes
);
router.get(
  "/d-get-requester-past-disputes/:type/:requesterID",
  RequesterPastDisputes
);
